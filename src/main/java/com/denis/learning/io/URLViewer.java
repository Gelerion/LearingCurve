package com.denis.learning.io;

import com.denis.learning.io.chapter_2.naked.streams.JStreamTextArea;
...
public class URLViewer extends JFrame
    ...
    private JStreamTextArea theDisplay = new JStreamTextArea(60, 72);
